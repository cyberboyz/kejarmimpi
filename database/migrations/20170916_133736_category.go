...
func (m *Category_20170916_133736) Up() {
	...
	m.SQL("CREATE TABLE category(id SERIAL PRIMARY KEY, category  name character varying(25), created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at timestamp NOT NULL)")
}
