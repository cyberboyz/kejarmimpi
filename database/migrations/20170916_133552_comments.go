...
func (m *Comments_20170916_133552) Up() {
	...
	m.SQL("CREATE TABLE comments(id SERIAL PRIMARY KEY, comment  TEXT NOT NULL, id_user SERIAL, id_article SERIAL, created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at timestamp NOT NULL)")
}
